    ...
    <section className="pb-20 pt-10 sm:pb-24 sm:pt-14">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <article className="panel rounded-[2.6rem] border border-line px-6 py-10 sm:px-10">
          <p className="font-display text-sm uppercase tracking-[0.34em] text-brand">Terms</p>
          <h1 className="mt-4 font-display text-5xl leading-[0.96] text-ink sm:text-6xl">Simple site terms.</h1>
