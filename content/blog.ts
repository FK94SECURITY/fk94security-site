...
export const blogPosts: BlogPost[] = [
  {
    slug: "como-saber-si-me-hackearon-el-celular",
    title: "Como saber si me hackearon el celular: señales que no podés ignorar",
    excerpt:
      "Descubre las señales de alerta que indican si tu celular fue hackeado. Guía practica con pasos concretos para detectar y proteger tu dispositivo.",
    date: "2026-03-17",
    category: "security-tip",
    readTime: "7 min read",
    content: `
      <p>Si te preguntás como saber si me hackearon el celular, probablemente ya notaste algo raro. Buena noticia: hay señales claras que te lo van a decir, y acciones concretas que podés tomar ahora mismo. Vamos a verlas juntos.</p><p>Tu celular es como tu billetera digital — adentro tenes datos personales, acceso a tus cuentas, fotos, mensajes privados. Si alguien lo hackea, tiene acceso a prácticamente todo. Por eso es importante que sepas reconocer los síntomas.</p><h2>Las señales mas claras de que te hackearon</h2><p>Antes que nada: algunos de estos síntomas también pueden ser por un celular lento o viejito. Pero si ves varios juntos, es momento de actuar.</p><h3>El celular se comporta extraño</h3><p>Si tu dispositivo hace cosas sin que vos hagas nada, es un gran indicador. Hablamos de:</p><ul><li><strong>Se abre solo aplicaciones</strong> que no tocaste — especialmente apps raras que no instalaste</li><li><strong>Hace clicks o toca cosas sin que hagas nada</strong> — eso se llama input fantasma</li><li><strong>Se reinicia solo</strong> sin motivo aparente</li><li><strong>Se calienta mucho</strong> sin que estés usando nada pesado</li></ul><p>Todo esto puede significar que hay código malicioso corriendo en background, consumiendo recursos.</p><h3>Bateria que se drena rapidísimo</h3><p>Si tu celular aguantaba un día completo y ahora llega a las 3 de la tarde con 10%, hay algo raro. El malware típicamente corre procesos en segundo plano que consumen un montón de energía. Abri Ajustes > Bateria (o Energia en iPhone) y fijate que app está usando mas. Si ves apps extrañas o desconocidas ahi, es una bandera roja.</p><h3>Datos moviles que se van al toque</h3><p>De repente te quedas sin datos o sin megas. Eso pasa porque el malware está mandando información tuya a servidores de atacantes. Si consumís muchos datos sin haber hecho nada, investigá que app está siendo la culpable.</p><h3>Cuentas comprometidas sin que las hayas tocado</strong></h3><p>Esta es seria: recibís notificaciones de login en tus cuentas (Gmail, Instagram, WhatsApp, Banco) desde lugares que no reconocés. O vos no cambiaste la contraseña pero de repente ya no podés entrar. Significa que alguien mas tiene acceso.</p><h3>Mensajes raros a tus contactos</h3><p>Te dicen que recibieron mensajes extraños de tu numero, o que vieron que publicaste cosas que vos no publicaste. Tu cuenta fue comprometida y usan tu celular para spamear o estafar a otros.</p><h3>Aparecen apps que vos no instalaste</h3><p>Este es un clásico. Mirás la pantalla de inicio y hay apps nuevas que nunca descargaste. O abris App Store / Play Store y en tus instaladas hay cosas raras. Eso es malware.</p><h2>Que hacer si sospechas que te hackearon</h2><p>Vale, encontraste uno o varios de estos síntomas. Acá va lo que tenes que hacer ahora mismo, paso a paso.</p><h3>Paso 1: Cambia contraseñas desde otra dispositivo</h3><p>Si usas tu celular hackeado para cambiar contraseñas, el hacker va a ver la nueva contraseña cuando la escribas. Por eso lo primero es usar otro dispositivo (computadora, tablet de un amigo, etc.). Empieza por tus cuentas importantes:</p><ul><li>Email principal (eso es la llave maestra — quien controle tu email controla todo)</li><li>Redes sociales (Instagram, Facebook, TikTok)</li><li>Apps de banco y dinero</li><li>WhatsApp y apps de mensajeria</li></ul><p>Usa contraseñas <strong>fuertes y unicas</strong> — no reutilices. Si no sabes como hacer contraseñas seguras, <a href="/guides">te mostramos en nuestras guias</a>.</p><h3>Paso 2: Activa autenticacion de dos factores (2FA)</h3><p>Despues de cambiar contraseñas, activa 2FA en todo. No SMS si podés (es vulnerable) — pedi que usen una app authenticator como Google Authenticator o Authy. Si el atacante no tiene tu teléfono fisico, no va a poder entrar aunque tenga la contraseña.</p><h3>Paso 3: Revisa qué apps tienen permiso a tus datos</h3><p>En tu celular hackeado, andá a:</p><p><strong>Android:</strong> Ajustes > Aplicaciones > Permisos (o Privacidad). Revisa que apps pueden acceder a tu ubicacion, contactos, fotos, micrófono, cámara. Si ves algo extraño, saca permisos o desinstala.</p><p><strong>iPhone:</strong> Ajustes > Privacidad. Hace lo mismo.</p><h3>Paso 4: Busca y elimina apps sospechosas</h3><p>Abri tu lista de aplicaciones instaladas y buscá cosas raras. Apps que no reconocés, con nombres genéricos, o que no deberian estar ahi. Presiona largo y desinstala. Si no te deja desinstalar, probablemente sea una app de sistema — marca como desactivada.</p><h3>Paso 5: Reinicia el celular en modo seguro</h3><p>Esto detiene todas las apps que no son de sistema. Si el celular funciona normal en modo seguro, confirma que era una app instalada la culpable.</p><p><strong>Android:</strong> Presiona largo el botón de apagado, tocá el icono de apagado y mantené presionado.</p><p><strong>iPhone:</strong> No tiene modo seguro como tal, pero podés reiniciar en modo de recuperación.</p><h3>Paso 6: Considera hacer factory reset</h3><p>Si encontraste malware serio, la opcion nuclear es formatear el celular (factory reset). Eso borra TODO y vuelve a dejarlo como nuevo — el malware se va porque se va todo. Pero antes:</p><ul><li>Haz backup de lo importante (fotos, contactos) — hacelo desde otra computadora o cuenta cloud limpia</li><li>Cambia TODAS tus contraseñas desde otra dispositivo primero</li><li>Despues sí, formatea</li></ul><p>Despues de formatear, reinstala solo las apps que realmente necesitas.</p><h2>Como prevenir que pase de nuevo</h2><p>Una vez que limpiaste el celular, no querés volver a pasar por esto. Acá van los basics:</p><ul><li><strong>Descarga apps solo desde App Store o Google Play</strong> — nada de APKs de sitios raros</li><li><strong>Mantén el OS actualizado</strong> — las actualizaciones parchean vulnerabilidades</li><li><strong>Usa un buen antivirus</strong> — no gratis y random, algo serio</li><li><strong>No hagas jailbreak o root</strong> — eso abre tu dispositivo a ataques</li><li><strong>Ten cuidado con WiFi publica</strong> — usa VPN si vas a acceder a cuentas sensibles</li><li><strong>No clickees links sospechosos</strong> en mensajes o emails — pueden ser phishing</li></ul><h2>Que hacer ahora</h2><p>Si leiste esto y te da paranoia, tranqui — es normal. Pero no esperes. Hoy mismo:</p><ol><li>Revisa tu celular usando los síntomas que mencionamos</li><li>Si encontraste algo raro, usa otra dispositivo para cambiar contraseñas</li><li>Activa 2FA en tus cuentas importantes</li><li>Si el problema persiste, considera el factory reset</li></ol><p>Y recorda: la mejor defensa es la prevencion. Usá contraseñas fuertes, descargas apps de lugares confiables, y mantén el software actualizado. Tu celular tiene acceso a todo lo importante — protegelo como si fuera tu billetera. Porque basicamente, lo es.</p>
    `,
  },
  {
