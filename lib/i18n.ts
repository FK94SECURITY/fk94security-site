...
export const translations = {
  en: {
    ...
    blog: {
      ...
      posts: [
        { slug: "national-public-data-breach", category: "Breach Alert", title: "How to Check If Your Data Was in the National Public Data Breach", excerpt: "800 million records exposed including SSNs and addresses. Here is how to check and protect yourself.", date: "2024-08-15" },
        ...
        { slug: "mfa-bypass-phishing", category: "News", title: "New Phishing Technique Bypasses MFA", excerpt: "Adversary-in-the-middle attacks can bypass traditional MFA. Here is how to stay safe.", date: "2024-12-01" },
      ],
    },
    faq: {
      kicker: "FAQ",
  ...
  es: {
    ...
    stats: {
      items: [
        { value: "13", label: "Herramientas Gratis" },
    ...
    blog: {
      ...
      posts: [
        { slug: "national-public-data-breach", category: "Alerta", title: "Cómo verificar si tus datos están en la filtración de National Public Data", excerpt: "800 millones de registros expuestos incluyendo SSNs y direcciones. Así podés verificar y protegerte.", date: "2024-08-15" },
        ...
        { slug: "mfa-bypass-phishing", category: "Noticias", title: "Nueva técnica de phishing que evade MFA", excerpt: "Los ataques adversary-in-the-middle pueden evadir MFA tradicional. Así podés protegerte.", date: "2024-12-01" },
      ],
    },
    faq: {
